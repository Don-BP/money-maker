...
export const metadata: Metadata = {
  ...
  description:
    "ZenithTools Terms of Service — the rules governing your use of our free online utility tools. Free for personal and commercial use.",
  alternates: { canonical: "https://zenithtools.vercel.app/legal/terms" },
  openGraph: {
    title: "Terms of Service | ZenithTools",
    description: "ZenithTools Terms of Service. Simple, fair, and clear.",
    url: "https://zenithtools.vercel.app/legal/terms",
    type: "website",
  },
};
...
const sections = [
  {
    ...
    content: "By accessing or using ZenithTools at zenithtools.vercel.app, you agree to be bound by these Terms of Service. If you do not agree, you may not use the Site. These Terms apply to all visitors and users.",
  },
  {
    title: "2. Description of Service",
    content: "ZenithTools provides free, browser-based utility tools including username generators, word finders, recipe scalers, Japanese text converters, and IP address checkers. All Tools run in your browser. No account is required.",
  },
  {
    title: "3. Permitted Use & Restrictions",
    content: "You may use ZenithTools for personal and commercial purposes. You must NOT:",
    bullets: [
  ...
  },
  {
    ...
    content: "The Site and its content are the exclusive property of ZenithTools. Output generated by our Tools (usernames, scaled recipes, etc.) belongs to you and may be used freely.",
  },
  {
  ...
  },
  {
    ...
    content: "TO THE MAXIMUM EXTENT PERMITTED BY LAW, ZENITHTOOLS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE SITE OR TOOLS.",
  },
  {
    title: "7. Advertising",
    content: "ZenithTools displays advertisements via Google AdSense to keep our tools free. By consenting to cookies, you acknowledge that ads may be personalized based on your browsing history. See our Privacy Policy for details.",
  },
  {
  ...
  {
    title: "10. Contact",
    content: "Questions? Email legal@zenithtools.com.",
  },
];
